...
export function GoogleButton({ label }: { label: string }) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="w-full h-11 rounded-xl border border-border bg-background/50 hover:bg-accent/10 flex items-center justify-center gap-3 text-sm font-medium transition-colors disabled:opacity-60"
    >
